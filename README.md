...
* [Wiki Page](https://mad-docs.readthedocs.io/en/async/) - For Installation instructions and other stuff
...
* A supported version of Python: **3.9**, **3.10**
* MySQL database
...
Have a look at our [Wiki](https://mad-docs.readthedocs.io/en/async/)

## Contributing

Information related to contributing to Map'A'Droid can be found [here](https://github.com/Map-A-Droid/MAD/blob/async/CONTRIBUTING.md)
